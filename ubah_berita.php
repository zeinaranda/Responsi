...
<head>
    ...
    <title>Halaman Admin - Ubah Berita</title>
</head>
                    ...
                    <div class="card col-lg-12 p-3">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Judul" name="judul" value="<?php echo $berita["judul"]; ?>">
                            </div>
                            <div class="mb-3">
                                ...
                                <Select class="form-select" name="kategori">
                                    ...
                                    foreach ($kategori as $row) :
                                        if ($berita["id_kategori"] == $row["id_kategori"]) {
                                    ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" rows="10" name="isi"><?php echo $berita["isi"]; ?></textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                ?>
                                <?php } else { ?>
                                    <img class="w-50 h-50" src="../img/<?php echo $berita["gambar"]; ?>" alt=" ">
                                <?php } ?>
                                <input type="file" class="form-control" name="gambar">
                            </div>
                            <button type="submit" class="btn btn-primary" name="submit">Simpan</button>
                            <a href="kelola_berita.php" class="btn btn-primary">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
