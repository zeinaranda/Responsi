...
$id = $_GET["id"];
$pengumuman = query("SELECT * FROM berita where id_berita=$id")[0];
$semua_pengumuman = query("SELECT * FROM berita,kategori where berita.id_kategori=kategori.id_kategori and berita.id_kategori=3");
$pengumuman_terbaru = array_reverse($semua_pengumuman);
?>
                ...
                <div class="card-body">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb flex-nowrap">
                            ...
                            <li class="breadcrumb-item text-decoration-none text-truncate"><a class="text-dark text-decoration-none" href="#">Pengumuman</a></li>
                            <li class="breadcrumb-item active text-truncate" aria-current="page"><?php echo $pengumuman["judul"]; ?></li>
                        </ol>
                    </nav>
                    <h3 class="py-3"><?php echo $pengumuman["judul"]; ?></h3>
                    <?php
                    ...
                    <?php } else { ?>
                        <div class="d-flex justify-content-center">
                            <img src="../img/<?php echo $pengumuman["gambar"]; ?>" class="h-75 w-75">
                        </div>
                    <?php } ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="py-3">
                        ...
                        <dl>
                            <?php $i = 0 ?>
                            <?php foreach ($pengumuman_terbaru as $row) : if ($i++ < 4) ?>
                                <dt><a href="pengumuman_page.php?id=<?php echo $row["id_berita"]; ?>" class="text-dark text-decoration-none"><?php echo $row["judul"]; ?></a></dt>
                            <?php endforeach; ?>
                        </dl>
                    </div>
                </div>
