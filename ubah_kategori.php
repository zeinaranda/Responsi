...
<head>
    ...
    <title>Halaman Admin - Ubah Kategori</title>
</head>
                ...
                <div class="row">
                    <div class="card col-lg-12 p-3">
                        ...
                        <form action="" method="post">
                            <input type="hidden" class="form-control" value="<?php echo $kategori["id_kategori"]; ?>" name="id_kategori">
                            <div class="mb-3">
                                <label for="" class="form-label">Kategori</label>
                                <input type="text" class="form-control" value="<?php echo $kategori["kategori"]; ?>" name="kategori">
                            </div>
