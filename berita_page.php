...
$id = $_GET["id"];
$berita = query("SELECT * FROM berita where id_berita=$id")[0];
$semua_berita = query("SELECT * FROM berita,kategori where berita.id_kategori=kategori.id_kategori");
$berita_terbaru = array_reverse($semua_berita);
?>
        ...
        <div class="col-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="py-3"><?php echo $berita["judul"]; ?></h3>
                    <?php
                    if (!$berita["gambar"]) {
            ...
            <div class="card">
                <div class="card-body">
                    <div class="py-3">
                        ...
                        <dl>
                            <?php $i = 0 ?>
                            <?php foreach ($berita_terbaru as $row) : if ($i++ < 4) ?>
                                <dt><a href="berita_page.php?id=<?php echo $row["id_berita"]; ?>" class="text-dark text-decoration-none"><?php echo $row["judul"]; ?></a></dt>
                            <?php endforeach; ?>
                        </dl>
                    </div>
                </div>
