...
<head>
    ...
    <title>Halaman Admin - Kelola Berita</title>
</head>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($berita as $row) : ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td style="width: 15%;">
                                            <a href="ubah_berita.php?id=<?php echo $row["id_berita"]; ?>" class="btn btn-primary btn-sm">Ubah</a>
                                            <a href="hapus_berita.php?id=<?php echo $row["id_berita"]; ?> " onclick="return confirm('Yakin Ingin Menghapus Data?');" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                        <td style="width: 10%;"><?php echo $row["id_berita"]; ?></td>
