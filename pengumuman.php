...
$pengumuman = query("SELECT * FROM berita,kategori where berita.id_kategori=kategori.id_kategori and berita.id_kategori=3");
$pengumuman_terbaru = array_reverse($pengumuman);
?>
...
<head>
    ...
    <title>Pengumuman - Universitas Palangka Raya</title>
    <style>
        ul.breadcrumb li a {
            color: #0275d8;
        ...
        <?php foreach ($pengumuman_terbaru as $row) : ?>
            <div class="col-md-3 py-3">
                <div class="card" style="width: 16rem;">
                    ...
                    <div class="card-body">
                        <a href="pages/pengumuman_page.php?id=<?php echo $row["id_berita"]; ?>" class="h6 link-dark card-title text-decoration-none"><?php echo $row["judul"]; ?></a>
