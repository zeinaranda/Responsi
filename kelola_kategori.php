                            ...
                            <tbody>
                                ...
                                <?php foreach ($kategori as $row) : ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td>
                                            <a href="ubah_kategori.php?id=<?php echo $row["id_kategori"]; ?>" class="btn btn-primary btn-sm">Ubah</a>
                                            <a href="hapus_kategori.php?id=<?php echo $row["id_kategori"]; ?>" onclick="return confirm('Yakin Ingin Menghapus Data?');" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
